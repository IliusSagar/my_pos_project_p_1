                                    ...
                                    <div class="panel-body">
                                        <form role="form" action="{{ url('/update-product/'.$prod->id) }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="selling_price" placeholder="Sell Price" required value="{{ $prod->selling_price }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <img src="{{ URL::to($prod->product_image) }}" style="height: 150px; width: 150px;">
                                            </div>
